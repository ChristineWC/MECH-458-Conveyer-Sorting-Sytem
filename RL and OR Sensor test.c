/*
The purpose of this test is to determine what information I am gathering and whether I am gathering the data properly
*/
...
int main()
{
    ...
    /*
    //If the LCD display doesn't work use the following code:
